...
@Client.on_message(
    commandpro(["play", "/play", "yt", "ytp", "/yt", "/ytp", "@", "#", ".play"])
    & filters.group
    & ~filters.forwarded
    & ~filters.via_bot
)
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/4d6107c3ec7b105eb755c.png"
...
@Client.on_message(commandpro([".end", "/end", "end", ".stp"]) & other_filters)
@errors
@authorized_users_only
